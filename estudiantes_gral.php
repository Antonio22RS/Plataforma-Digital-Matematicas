...
<body>
        ...
        <div class='container'>
          ...
          <div class='row align-items-center text-center text-md-end g-3'>
            ...
            <div class='col-12 col-md-10'>
              ...
              <div class='mt-3'>
                <a href='inicio_doc.php' class='btn btn-outline-danger me-2 mb-2 mb-md-0' role='button'>ATRÁS</a>
              </div>
            </div>
  ...
  include('conexion.php');
  $sqle = "SELECT a.NCONTROL, a.NAME, a.LASTNAME,
           b.MATEMATICAS_I, b.MATEMATICAS_II, b.MATEMATICAS_III,
           b.MATEMATICAS_IV, b.MATEMATICAS_V, b.MATEMATICAS_VI
           from estudiantes a 
           JOIN calificaciones b ON a.NCONTROL = b.NCONTROL_ST;";
      ...
      <table class='table table-bordered align-middle shadow-sm mx-auto w-100 w-md-75 w-lg-50'>
        <thead class='table-light'>
          <tr>
            ...
            <th scope='col'>MATEMATICAS I</th>
            <th scope='col'>MATEMATICAS II</th>
            <th scope='col'>MATEMATICAS III</th>
            <th scope='col'>MATEMATICAS IV</th>
            <th scope='col'>MATEMATICAS V</th>
            <th scope='col'>MATEMATICAS VI</th>
            <th scope='col'>ACCIONES</th>
          </tr>
        </thead>
        <tbody>";

  while ($re = $datose->fetch_assoc()) {
    echo "<tr>
<td class='texto-rojo'>" . $re["NCONTROL"] . "</td>
<td class='texto-rojo'>" . $re["NAME"] . "</td>
<td class='texto-rojo'>" . $re["LASTNAME"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_I"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_II"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_III"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_IV"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_V"] . "</td>
<td class='texto-rojo'>" . $re["MATEMATICAS_VI"] . "</td>
<td class='texto-rojo'>Ver/Editar/Eliminar</td>
</tr>";
  }
